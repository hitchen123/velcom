  ...
  $custom_settings = array( 
    'contextual_help' => array( 
      'content'       => array( 
        array(
          ...
          'title'     => __( 'Тип блока', 'theme-text-domain' ),
          'content'   => '<p>' . __( 'Контент', 'theme-text-domain' ) . '</p>'
        )
      ),
    ...
    'settings'        => array(
      ...
      array(
        'id'          => 'header_logo_left',
        'label'       => 'Логотип слева',
        'desc'        => 'Загрузите логотип, который будет отображаться слева в шарке сайта.',
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'header'
      ),
      ...
      array(
        ...
        'desc'        => 'Загрузите логотип, который будет отображаться справа в шарке сайта.',
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'header'
      ),
      ...
      array(
        'id'          => 'apps_ios_link',
        'label'       => 'Ссылка на приложение ios',
        'desc'        => '  ',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'apps'
      ...
      array(
        ...
        'section'     => 'slider',
        'type'        => 'list-item',
        'desc'        => 'Слайдер. Можно перетягиванием поменять слайды местами. Поле title - название в списке.',
        'std'         => '',
        'condition'   => '',
        'settings'    => array(
          // array(
      ...
      array(
        'id'          => 'blogger_card_description-11',
        'label'       => 'Имя 2 для подробностей',
        'desc'        => '   ',
        'std'         => '',
        'type'        => 'text',
      ...
      array(
        'id'          => 'blogger_card_social_link-11',
        'label'       => 'Ссылка на профиль блогера в соцсети',
        'desc'        => '   ',
        'std'         => '',
        'type'        => 'text',
      ...
      array(
        'id'          => 'blogger_card_main_title_big-11',
        'label'       => 'Подзаголовок h2',
        'desc'        => '   ',
        'std'         => '',
        'type'        => 'text',
      ...
      array(
        'id'          => 'blogger_card_description-12',
        'label'       => 'Имя 2 для подробностей',
        'desc'        => '   ',
        'std'         => '',
        'type'        => 'text',
      ...
      array(
        'id'          => 'blogger_card_social_link-12',
        'label'       => 'Ссылка на профиль блогера в соцсети',
        'desc'        => '   ',
        'std'         => '',
        'type'        => 'text',
      ...
      array(
        'id'          => 'blogger_card_main_title_big-12',
        'label'       => 'Подзаголовок h2',
        'desc'        => '   ',
        'std'         => '',
        'type'        => 'text',
      ...
      array(
        'id'          => 'blogger_card_description-13',
        'label'       => 'Имя 2 для подробностей',
        'desc'        => '   ',
        'std'         => '',
        'type'        => 'text',
      ...
      array(
        'id'          => 'blogger_card_social_link-13',
        'label'       => 'Ссылка на профиль блогера в соцсети',
        'desc'        => '   ',
        'std'         => '',
        'type'        => 'text',
      ...
      array(
        'id'          => 'blogger_card_main_title_big-13',
        'label'       => 'Подзаголовок h2',
        'desc'        => '   ',
        'std'         => '',
        'type'        => 'text',
      ...
      array(
        'id'          => 'blogger_card_description-14',
        'label'       => 'Имя 2 для подробностей',
        'desc'        => '   ',
        'std'         => '',
        'type'        => 'text',
      ...
      array(
        'id'          => 'blogger_card_social_link-14',
        'label'       => 'Ссылка на профиль блогера в соцсети',
        'desc'        => '   ',
        'std'         => '',
        'type'        => 'text',
      ...
      array(
        'id'          => 'blogger_card_main_title_big-14',
        'label'       => 'Подзаголовок h2',
        'desc'        => '   ',
        'std'         => '',
        'type'        => 'text',
      ...
      // rules
      array(
        'id'          => 'book_rules_mobile',
        'label'       => 'Правила использования мобильного приложения',
        'section'     => 'rules',
        'desc'        => '  ',
        'std'         => '',
        'type'        => 'text'
      ...
      array(
        'id'          => 'book_rules_mobile_link',
        'label'       => 'Ссылка на правила приложения',
        'section'     => 'rules',
        'desc'        => '  ',
        'std'         => '',
        'type'        => 'text'
      ...
      array(
        'id'          => 'book_rules_card_link',
        'label'       => 'Ссылка на правила карты',
        'section'     => 'rules',
        'desc'        => '  ',
        'std'         => '',
        'type'        => 'text'
